...
public class CreateCategoryUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsCreateCategory_shouldReturnCategoryId() {
        ...
        Mockito.verify(categoryGateway, times(1)).create(Mockito.argThat(
                aCategory -> (
    ...
    @Test
    public void givenAnInvalidNameWithInactiveCategory_whenCallsCreateCategory_thenShouldReturnInactiveCategoryId() {
