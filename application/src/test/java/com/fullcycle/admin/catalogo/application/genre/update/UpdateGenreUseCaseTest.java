...
public class UpdateGenreUseCaseTest extends UseCaseTest {
    ...
    public void givenAValidCommand_whenCallsUpdateGenre_shouldReturnGenreId() {
        ...
        final var expectedlId = aGenre.getId();
        final var expectedName = "Ação";
        final var expectedIsActive = true;
        final var expectedCategories = List.<CategoryID>of();

        final var aCommand = UpdateGenreCommand.
                with(expectedlId.getValue(), expectedName, expectedIsActive, asString(expectedCategories));
        ...
        Assertions.assertEquals(expectedlId.getValue(), actualOutput.id());

        verify(genreGateway, times(1)).findById(eq(expectedlId));
        verify(genreGateway, times(1)).update(argThat(aUpdatedGenre ->
                Objects.equals(expectedlId, aUpdatedGenre.getId())
    ...
    @Test
    public void givenAnInvalidName_whenCallsUpdateGenreAdSomeCategoriesDoesNotExists_shouldReturnNotificationException() {
        //given
        final var aGenre = Genre.newGenre("acao", true);
