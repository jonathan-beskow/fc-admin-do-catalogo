...
public class GenreTest {
    ...
    @Test
    public void givenAValidParams_whenCallNewGenre_shouldInstantiateANewGenre() {
    ...
    @Test
    public void givenAInvalidNullNames_whenCallNewGenreAndValidate_shouldReceiveAError() {
    ...
    @Test
    public void givenAValidGenre_whenCallUpdateWithNullCategory_shouldReceiveOK() {
    ...
    @Test
    public void givenAInvalidNullAsCategoryID_whenCallAddCategoriesWithEmptyList_shouldReceiveOK() {
        final var expectedName = "Ação";
        final var expectedIsActive = true;
    ...
    @Test
    public void givenAInvalidNullAsCategoryID_whenCallAddCategoriesWithNullList_shouldReceiveOK() {
        final var expectedName = "Ação";
        final var expectedIsActive = true;
        final var expectedCategories = List.<CategoryID>of();
