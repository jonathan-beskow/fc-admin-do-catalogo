package com.fullcycle.admin.catalogo.api.controllers;
...
import com.fullcycle.admin.catalogo.category.models.CategoryListResponse;
import com.fullcycle.admin.catalogo.category.models.CategoryResponse;
...
import com.fullcycle.admin.catalogo.category.presenters.CategoryApiPresenter;
...
public class CategoryController implements CategoryAPI {
    ...
    public CategoryController(final CreateCategoryUseCase createCategoryUseCase, GetCategoryByIdUseCase getCategoryByIdUseCase, UpdateCategoryUseCase updateCategoryUseCase, DeleteCategoryUseCase deleteCategoryUseCase, ListCategoriesUseCase listCategoriesUseCase) {
    ...
    public Pagination<CategoryListResponse> listCategories(String search, int page, int perPage, String sort, String direction) {
        return
                listCategoriesUseCase.execute(new SearchQuery(page, perPage, search, sort, direction))
