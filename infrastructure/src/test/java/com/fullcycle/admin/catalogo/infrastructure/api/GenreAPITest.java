...
import com.fullcycle.admin.catalogo.api.GenreAPI;
...
public class GenreAPITest {
    ...
    @Test
    public void givenAnValidCommand_whenCallsCreateGenre_shouldReturnGenreId() throws Exception {
        //given
    ...
    @Test
    public void givenAInalidName_whenCallsCreateGenre_shouldReturnNotification() throws Exception {
        //given
    ...
    public void givenValidParams_whenCallsListGenres_ShouldReturnGenres() throws Exception {
        ...
        //when
        final var aRequest = get("/genres").queryParam("page", String.valueOf(expectedPage))
